...
class OCTFADataset(Dataset):
    ...
    """
    def __init__(self, root_dir='/data/student/Fengjunming/ROMA/data/operation_pre_filtered_octfa', split='train', mode='fa2oct'):
        ...
        print(f"[OCTFADataset] {split} set: {len(self.samples)} samples (total {num_total})")
